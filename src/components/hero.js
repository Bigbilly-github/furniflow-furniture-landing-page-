  ...
  return (
    <>
      <section className="sm:h-[550px] lg:h-[620px] h-[400px] w-full flex justify-center items-center mt-[80px] bg-[#3B5D50] ">
        <motion.div
          className='w-[85%] sm:h-[500px] h-[380px] flex  lg:flex-row justify-between items-center lg:bg-[url("../../public/svg/hero/Dot.svg")]  bg-no-repeat bg-right-top bg-[length:200px_300px] rounded-[20px] p-[30px] flex-col  gap-[30px]'
        ...
        >
          ...
          <Image
            src={couch}
            alt="image of a couch"
            className="object-contain sm:w-[400px] sm:h-[400px] w-[350px] h-[350px] lg:w-[500px] lg:h-[500px] xl:w-[700px] xl:h-[700px]"
          />
        </motion.div>
      </section>
    </>
