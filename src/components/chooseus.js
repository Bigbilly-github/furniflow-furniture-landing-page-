  ...
  const details = [
    {
      ...
      subtext:
        "We deliver your furniture quickly and at no extra cost, on-time arrival and no hidden fees.",
    },
    {
      image: bagicon,
      maintext: "Easy to Shop ",
      subtext:
        "Our user-friendly platform lets you browse, compare, and buy with ease. Desktop or mobile, shopping with us is effortless and enjoyable.",
    },
    {
      image: returnicon,
      maintext: "Easy to Shop ",
      subtext:
        "Each piece is handpicked for quality, comfort, and style. Timeless designs and modern essentials that fit your taste.",
    },
    {
      image: supporticon,
      maintext: "24/7 Support ",
      subtext:
        "Our support team is available day and night to assist you, because great service doesn’t sleep.",
    },
  ];
  return (
    <>
         ...
         initial={{ opacity: 0, x: 200 }}
          ...
          <div className="flex flex-col gap-[50px] ">
            <div className="self-center md:self-start">
              ...
              <p className="text-[#6A6A6A] lg:text-[14px] md:text-[14px] text-[16px]  lg:w-[444px] md:w-[350px] mt-[27px] leading-[24px]">
                Discover the difference with our customer-first
                approach,round-the-clock support,and smooth, secure, and
          ...
          <div>
            <Image
              src={image1}
              alt="image of a interior decoration"
